package com.usdj.shop.categorysecond.adminaction;

import java.util.List;

import com.usdj.shop.category.service.CategoryService;
import com.usdj.shop.category.vo.Category;
import com.usdj.shop.categorysecond.service.CategorySecondService;
...
public class AdminCategorySecondAction extends ActionSupport implements ModelDriven<CategorySecond> {
	private static final long serialVersionUID = -2347857467274077031L;
	// 模型驱动使用的对象
